# Storage in the AWS Web Services
...
+ [Amazon Elastic File System \(Amazon EFS\)](#amazon-efs-file-system)
...
You can also attach EBS volumes to a running instance\. For more information, see [Attaching an Amazon EBS volume to an instance](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-attaching-volume.html)\.
